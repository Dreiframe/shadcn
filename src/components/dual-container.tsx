...
//import { InfoDialog } from "./info-dialgo"
    ...
    return(
        <div className="border flex flex-wrap justify-center">
            ...
            <div className="w-[500px] h-[572px] m-2">
                ...
                <div className="w-[500px] h-[72px] border border-stone-800 items-center flex">
                    <div className="w-1/3 text-left pl-2">
                        <p className="text-sm font-semibold">lat: 62.123123</p>
                        <p className="text-sm font-semibold">lng: 30.3215</p>
                    </div>
            ...
            <div className="w-[500px] h-[572px] m-2">
                <div className="w-[500px] h-[500px] border text-center content-center">
                    <h2 className="text-lg font-semibold">PCD</h2>
                </div>
